  ...
  return (
    <div className="mt-4">
      <div className="flex items-center justify-between py-2">
        <h1 className="py-2 font-[500] text-[14px] leading-3">
      ...
      <div className="border border-[#CBCBCB] rounded">
        <p className="text-[12px] font-[400] leading-3 text-[#676666] p-4">
          <span className="text-[#1A3875]">Gurpreet Singh</span> (Dispatch team)
          has created{' '}
